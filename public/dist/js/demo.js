...
(function ($) {
  ...
  $container.append(
    '<h5>Personalizar Vista</h5><hr class="mb-2"/>'
    + '<h6>Menú Colores</h6>'
  )
  ...
  $checkbox_container.append('<span>Sin borde</span>')
  ...
  $container.append('<h6>Selector Barra Lateral</h6>')
  ...
  $container.append('<h6>Cuadro de Logo</h6>')
  ...
  }).text('Limpiar').on('click', function () {
    var $logo = $('.brand-link')
