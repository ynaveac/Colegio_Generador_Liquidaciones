...
<div>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Mantenedor de Bancos</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-6">
                                <label>Nombre</label>
                                <input type="text" class="form-control" id="banco" v-model="banco" placeholder="Ingrese nombre banco" required>
                            </div>
                ...
                <form role="form" @submit.prevent="edit">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                    
                            ...
                            <div class="form-group col-md-6">
                                    <label>Nombre</label>
                                    <input type="text" class="form-control" id="banco" v-model="banco_edit" placeholder="Ingrese nombre banco" required>
                                </div>
    ...
    export default {    
        ...
        methods:{
            ...
            editar: function(item, index){
                ...
                this.banco_edit                  = item[0].nombre                //this.empleado_edit.rut = item.rut            
            },
            ...
            edit(){
                ...
                axios.put(`/banco/${this.id_edit}`, params)
                    .then( res => {                        
