...
<div>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Mantenedor de Modo de Pago</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                        <router-link to="/home" class="breadcrumb-item">Home</router-link>
                        <li class="breadcrumb-item active">Modo Pago</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-6">
                                <label>Nombre</label>
                                <input type="text" class="form-control" id="mpago" v-model="modopago" placeholder="Ingrese modo de pago" required>
                            </div>
                ...
                <form role="form" @submit.prevent="edit">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                    
                            ...
                            <div class="form-group col-md-6">
                                    <label>Nombre</label>
                                    <input type="text" class="form-control" id="mpago" v-model="modopago_edit" placeholder="Ingrese modo de pago" required>
                                </div>
...
<script>
    ...
    export default {    
        ...
        mounted() {
            console.log('Componente modo pago.') 
        },
        ...
        methods:{
            ...
            editar: function(item, index){
                ...
                this.modopago_edit                  = item[0].nombre                //this.empleado_edit.rut = item.rut            
            },
            ...
            agregar(){
                ...
                const params = { 
                                 nombre : this.modopago                                  
                                }

                this.limpiar()                              

                axios.post('/modopago', params)  
                    .then( res => {
            ...
            edit(){
                ...
                axios.put(`/modopago/${this.id_edit}`, params)
                    .then( res => {                        
