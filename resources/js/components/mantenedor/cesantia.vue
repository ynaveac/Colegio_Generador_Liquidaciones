...
<div>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Mantenedor Indicador Seguro de Cesantia</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                        <router-link to="/home" class="breadcrumb-item">Home</router-link>
                        <li class="breadcrumb-item active">Cesantia</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="modal-dialog" role="document">
                ...
                <form role="form" @submit.prevent="agregar">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="AgregarModal">Agregar Nuevo Indicador</h5>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" step="000.01" min="000.00" max="999.99"
                                       id="descuento" name="descuento" maxlength="4" size="4" placeholder="Ej: 1.45" v-model="cesantia.descuento" required>
                            </div>                           

                            <div class="form-group col-md-6">
                                <label for="estado">Estado</label>
                                <multiselect 
                                    v-model="cesantia.estado" 
                                    :options="opciones"
                                    :searchable="false" 
            ...
            <div class="modal-dialog" role="document">
                ...
                <form role="form" @submit.prevent="edit">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditarModal">Editar Indicar de Censantia</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>% Descuento</label>
                                <input type="number" class="form-control" step="000.01" min="000.00" max="999.99"
                                       id="descuento" name="descuento" maxlength="4" size="4" placeholder="Ej: 1.45" v-model="cesantia_edit.descuento" required>
                            </div>                           

                            <div class="form-group col-md-6">
                                <label for="estado">Estado</label>
                                <multiselect 
                                    v-model="cesantia_edit.estado" 
                                    :options="opciones"
                                    :searchable="false" 
                                    :close-on-select="true" 
                                    :show-labels="false" placeholder="Seleccione...">
...
<script>
    ...
    export default {    
        ...
        mounted() {
            console.log('Componente Cesantia.') 
        },
        ...
        data(){
            return {
                ...
                cesantia       : { descuento: '', estado: '' },
                cesantia_edit  : { descuento: '', estado: '' },
                id_edit        : '',
                indice         : ''                                    
            }
        ...
        methods:{
            ...
            limpiar(){
                this.cesantia.descuento = "";
                this.cesantia.estado = "";      
                this.cesantia_edit.descuento = "";
                this.cesantia_edit.estado = "";                            
            },
            ...
            agregar(){
                ...
                console.log( this.cesantia.descuento, this.cesantia.estado );
                const params = { descuento : this.cesantia.descuento, estado : this.cesantia.estado }
                
                this.limpiar()              

                axios.post('/cesantia', params)
                    .then( res => {
                        var table = $('#datatable').DataTable( ) 
            ...
            editar: function(item, index){
                ...
                this.cesantia_edit.descuento      = item[0].descuento                
                this.cesantia_edit.estado         = item[0].estado 
            ...
            edit(){
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        const params = { descuento : this.cesantia_edit.descuento, estado : this.cesantia_edit.estado };;
                        console.log(params)

                            axios.put(`/cesantia/${this.id_edit}`, params)
                                .then(res => {
