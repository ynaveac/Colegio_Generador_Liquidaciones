...
<div>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Mantenedor Cajas de Compensación</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Nombre Caja de Compensación</label>
                                <input type="text" class="form-control" id="nombre" v-model="caja" placeholder="Nombres" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label>% Descuento</label>
                                <input type="number" class="form-control" step="000.01" min="000.00" max="999.99"
                                       id="descuento" name="descuento" maxlength="4" size="4" placeholder="Ej: 1.45" v-model="descuento" required>
                            </div>   
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                    
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Nombre Caja de Compensación</label>
                                    <input type="text" class="form-control" id="nombre" v-model="caja_edit" placeholder="Nombres" required>
                                </div>

                            <div class="form-group col-md-6">
                                <label>% Descuento</label>
                                <input type="number" class="form-control" step="000.01" min="000.00" max="999.99"
                                       id="descuento" name="descuento" maxlength="4" size="4" placeholder="Ej: 1.45" v-model="descuento_edit" required>
                            </div>  
...
<script>
    ...
    export default {    
        ...
        mounted() {
            console.log('Componente caja de compensacion.') 
        },
        ...
        methods:{
                ...
                axios.get(`/cajacompensacion?id=${''}`)
                    .then(res => {
                        ...
                        $('#datatable ').on('click', 'button.delete', function (e) {
                            ...
                            axios.delete(`/cajacompensacion/${data}`)
                                .then(()=>{
                        ...
                        $('#datatable ').on('click', 'button.edit', function (e) {
                            ...
                            axios.get(`/cajacompensacion?id=${data}`)
                            .then(res => {                      
                                console.log(res.data)
            ...
            editar: function(item, index){
                ...
                this.caja_edit                     = item[0].nombre                //this.empleado_edit.rut = item.rut            
                this.descuento_edit                = item[0].descuento
            },
            ...
            agregar(){
                ...
                axios.post('/cajacompensacion', params)  
                    .then( res => {
            ...
            edit(){
                ...
                const params = { 
                                 nombre : this.caja_edit ,
                                 descuento : this.descuento_edit
                                }
                ...
                axios.put(`/cajacompensacion/${this.id_edit}`, params)
                    .then( res => {                        
