                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea rows="3" class="form-control" id="descripcion" name="descripcion" v-model="cargo.descripcion" placeholder="Ingrese una descripción.">
                                </textarea>                                
                            </div>                            
                        </div>
                ...
                <form role="form" @submit.prevent="edit">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="descripcion">Descripción</label>
                                <textarea rows="3" class="form-control" id="descripcion" name="descripcion" v-model="cargo_edit.descripcion" placeholder="Ingrese una descripción.">
                                </textarea>                                
                            </div>                            
                        </div>
