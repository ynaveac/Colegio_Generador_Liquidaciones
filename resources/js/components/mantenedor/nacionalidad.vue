...
<div>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Mantenedor de Nacionalidad</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-row">
                            <div class="form-group ">
                                <label>Nombre de Nacionalidad</label>
                                <input type="text" class="form-control" id="nacion" v-model="nacion" placeholder="Ingrese Nacionalidad" required>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                    
                            ...
                            <div class="form-row">
                                <div class="form-group ">
                                    <label>Nombre de Nacionalidad</label>
                                    <input type="text" class="form-control" id="nacion" v-model="nacion_edit" placeholder="Ingrese Nacionalidad" required>
                                </div>
...
<script>
    ...
    export default {    
        ...
        mounted() {
            console.log('Componente nacionalidad.') 
        },
        ...
        methods:{
                ...
                axios.get(`/nacionalidad?id=${''}`)
                    .then(res => {
                        ...
                        $('#datatable ').on('click', 'button.delete', function (e) {
                            ...
                            axios.delete(`/nacionalidad/${data}`)
                                .then(()=>{
                        ...
                        $('#datatable ').on('click', 'button.edit', function (e) {
                            ...
                            axios.get(`/nacionalidad?id=${data}`)
                            .then(res => {                      
                                console.log(res.data)
            ...
            editar: function(item, index){
                ...
                this.nacion_edit                     = item[0].nombre                //this.empleado_edit.rut = item.rut            
            },
            ...
            agregar(){
                ...
                axios.post('/nacionalidad', params)  
                    .then( res => {
            ...
            edit(){
                ...
                axios.put(`/nacionalidad/${this.id_edit}`, params)
                    .then( res => {                        
